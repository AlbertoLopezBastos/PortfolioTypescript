    ...
    <section id="about" className={s.about} >
      ...
      <div className={s.container}>
        ...
        <div className={s.logosGrid}>
          ...
          <img className={s.logo} src={Images.react} alt="react logo"/>
          <img className={s.logo} src={Images.next} alt="next logo"/>
          <img className={s.logo} src={Images.node} alt="node logo"/>
        </div>
      </div>
    </section>
  )
